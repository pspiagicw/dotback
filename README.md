...
Install directly from GitHub releases (fresh system, no clone/build required):
...
```sh
curl -fsSL https://raw.githubusercontent.com/pspiagicw/dotback/main/install.sh | VERSION=v0.1.0 bash
```
